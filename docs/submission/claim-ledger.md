...
| Final accepted command | `python submission_inference_cli.py --image-dir <directory> --bundle-dir artifacts/issue-7-fusion-v2 --rgb-checkpoint <community-forensics-384.safetensors> --signal-model <signal-model.json> --output predictions.json --device auto --batch-size 8`; independently reviewed and accepted at Issue #10 commit `b8982dfb3400fa92fde65cc0ea6f2fe141a4b402`; `rgb_cli.py` is not a substitute |
