...
| 1:25–1:45 (20s) | Show the report's claim-ledger-complete sanitized cases covering clean/transformed false positives and false negatives, with corruption-family labels and the provisional-threshold trade-off. Say: “We inspect errors only on source-disjoint internal validation. Static fusion combines complementary evidence but does not adapt its trust per image.” |
