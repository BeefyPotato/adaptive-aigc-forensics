...
| 1:25–1:45 (20s) | Show two pre-approved internal-validation FP/FN records with source IDs redacted as necessary, their corruption-family labels, and a provisional threshold note. Say: “We inspect errors only on source-disjoint internal validation. The trade-off is that raw RGB inference is reproducible but does not adapt trust by degradation.” |
